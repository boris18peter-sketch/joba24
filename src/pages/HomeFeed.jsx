      ...
      <div className="px-4" style={{ paddingTop: 12, paddingBottom: 8 }}>
        ...
        {activeTab === 'available' && (
          <>
            ...
            <div style={{ position: 'sticky', top: 50, zIndex: 40, background: 'var(--surface-1)', paddingTop: 12, paddingBottom: 4, marginTop: -12, marginLeft: -16, marginRight: -16, paddingLeft: 16, paddingRight: 16 }}>
        ...
        {activeTab === 'my_published' && (() => {
          ...
          return (
            <div>
              ...
              <div style={{ display: 'flex', gap: 6, marginBottom: 14, position: 'sticky', top: 50, zIndex: 40, background: 'var(--surface-1)', paddingTop: 12, paddingBottom: 8, marginTop: -12, marginLeft: -16, marginRight: -16, paddingLeft: 16, paddingRight: 16 }}>
                {MY_PUB_TABS.map(t => {
