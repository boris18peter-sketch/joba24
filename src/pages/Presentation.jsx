...
function Slide1() {
  return (
    <div dir="rtl" style={{ height: '100%', background: DARK_BG, display: 'flex', flexDirection: 'column', padding: 0, position: 'relative', overflow: 'hidden' }}>
      ...
      <img src="https://media.base44.com/images/public/69e6bdb4986a04a256653a23/37041ac60_Gemini_Generated_Image_smo18vsmo18vsmo1.png" alt="Joba24" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
    </div>
  );
}
