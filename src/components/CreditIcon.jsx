...
export default function CreditIcon({ size = 36, style = {} }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Drop shadow */}
        <ellipse cx="16" cy="29" rx="10" ry="2.5" fill="rgba(26,111,212,0.3)" />

        {/* Coin bottom face (3D depth) - כחול כהה */}
        ...
        {/* Shine highlight */}
        <ellipse cx="12" cy="10" rx="4.5" ry="2.8" fill="rgba(255,255,255,0.45)" transform="rotate(-20 12 10)" />
        ...
        <text
          ...
          style={{ filter: 'drop-shadow(0 1.5px 2px rgba(10,82,176,0.4))' }}
        >
          J
        </text>
