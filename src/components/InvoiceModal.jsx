      ...
      const invoiceHtml = `
        <div dir="rtl" style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px">
          ...
          <table style="width:100%;border-collapse:collapse;margin:20px 0">
            ...
            <tr style="background:#f9f5ff"><td style="padding:8px;color:#666;font-weight:bold">סכום:</td><td style="padding:8px;font-size:20px;font-weight:900;color:#7c3aed">₪${task.price}</td></tr>
          ...
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: '#64748b', marginTop: 1 }}>{task.title} · <strong style={{ color: '#7c3aed' }}>₪{task.price}</strong></div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 20 }}>
              {[
                ...
                { key: 'email', label: 'אימייל לשליחה', placeholder: 'your@email.com' },
              ].map(f => (
                <div key={f.key}>
