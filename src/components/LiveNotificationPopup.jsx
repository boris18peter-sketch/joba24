...
const TYPES = {
  ...
  task_taken: {
    ...
    border: '#86efac',
    accent: '#16a34a',
    title: (n) => 'עובד זמין וממתין לאישורך',
    body: (n) => `"${n.taskTitle}" — לחץ לאישור`,
  ...
  application_received: {
    ...
    border: '#c4b5fd',
    accent: '#7c3aed',
    title: (n) => 'עובד חדש מגיש בקשה',
    body: (n) => `"${n.taskTitle}" — לחץ לבדוק ולאשר`,
    link: (n) => n.taskId ? `/task/${n.taskId}` : null,
  },
  application_approved: {
    ...
    body: (n) => `"${n.taskTitle}" — לחץ לצאת לדרך`,
    link: (n) => n.taskId ? `/task/${n.taskId}` : null,
  },
  application_sent: {
    emoji: '📤',
    ...
    body: () => 'הקרדיטים נוכו — ממתין לאישור המפרסם',
    link: (n) => n.taskId ? `/task/${n.taskId}` : null,
  },
  application_rejected: {
    ...
    border: '#fca5a5',
    accent: '#dc2626',
    title: () => 'המפרסם דחה את הבקשה שלך',
    body: (n) => `"${n.taskTitle}" — תוכל לנסות משימות אחרות`,
    link: (n) => n.taskId ? `/task/${n.taskId}` : null,
  },
  worker_on_the_way: {
    emoji: '🛵',
    ...
    border: '#93c5fd',
    accent: '#1a6fd4',
    title: (n) => 'העובד יצא לדרך אליך!',
    body: (n) => `"${n.taskTitle}" — מגיע אליך עכשיו`,
    link: (n) => n.taskId ? `/task/${n.taskId}` : null,
  },
  worker_arrived: {
    emoji: '📍',
    ...
    border: '#fde047',
    accent: '#ca8a04',
    title: (n) => 'העובד הגיע למיקום!',
    body: (n) => `"${n.taskTitle}" — עומד לפתחך`,
    link: (n) => n.taskId ? `/task/${n.taskId}` : null,
  },
  worker_done: {
    emoji: '✅',
    ...
    border: '#86efac',
    accent: '#16a34a',
    title: (n) => 'העובד סיים את המשימה!',
    body: (n) => `"${n.taskTitle}" — אשר ושחרר תשלום`,
    link: (n) => n.taskId ? `/task/${n.taskId}` : null,
  },
  new_review: {
    emoji: '⭐',
  ...
  worker_left_task: {
    ...
    body: (n) => `"${n.taskTitle}" — המשימה פתוחה שוב לעובדים אחרים`,
    link: (n) => n.taskId ? `/task/${n.taskId}` : null,
  },
  no_show_reported: {
    emoji: '⚠️',
