...
import { Menu, X, Home, Map, Plus, User, Wallet, Trophy } from 'lucide-react';
    ...
    <>
      <button
        ...
        style={{
          ...
          width: 40, height: 40, borderRadius: 12, background: 'black',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          border: 'none', cursor: 'pointer', boxShadow: '0 2px 12px rgba(0,0,0,0.18)',
        }}
      >
