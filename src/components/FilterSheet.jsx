...
export default function FilterSheet({ open, onClose, filters, onApply }) {
  ...
  return (
    <Sheet open={open} onOpenChange={onClose}>
      <SheetContent side="bottom" className="rounded-t-[28px]" style={{ maxHeight: '90dvh', overflow: 'hidden', paddingBottom: 'max(32px, env(safe-area-inset-bottom))', display: 'flex', flexDirection: 'column', zIndex: 10000 }} dir="rtl">
