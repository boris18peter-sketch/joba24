...
export default function TaskCardWithSwipe({ task, onDismiss, myApp, isMyTask, currentUserId }) {
  ...
  return (
    ...
    >
      ...
      >
        <TaskCard task={task} myApp={myApp} isMyTask={isMyTask} currentUserId={currentUserId} />
      </div>
    </div>
  );
}